...
class WPSC_Settings_Tab_Shipping extends WPSC_Settings_Tab {
	...
	public function display() {
		...
		<h3><?php esc_html_e( 'Postnummer Settings', 'wp-e-commerce'); ?></h3>
		<table class='form-table'>
			<tr>			
				<th scope="row">Sjælland, Lolland-Falster</th>
				<td>
					<textarea style="width: 100%; height: 100px" name='wpsc_options[sealand_zipcode]'><?php echo esc_attr( get_option( 'sealand_zipcode' ) ); ?></textarea>
				</td>
			</tr>
			<tr>			
				<th scope="row">Nordsjælland, Nord for Skovvejen/Holbækmotorvejen</th>
				<td>
					<textarea style="width: 100%;  height: 100px" name='wpsc_options[norland_zipcode]'><?php echo esc_attr( get_option( 'norland_zipcode' ) ); ?></textarea>
				</td>
			</tr>
			<tr>			
				<th scope="row">Fri Fragt</th>
				<td>
					<textarea style="width: 100%;  height: 100px" name='wpsc_options[free_zipcode]'><?php echo esc_attr( get_option( 'free_zipcode' ) ); ?></textarea>
				</td>
			</tr>
		</table>
